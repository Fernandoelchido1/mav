        ...
        <div class="container"><br>
            <section class="row">
                <article class="col-md-12">
                    <h1 class="align-content-center text-center" style="font-size: rem; letter-spacing: 3px;">PARTICIPACIÓN DE LOS TRABAJADORES EN LAS UTILIDADES DE LA EMPRESA</h1><br>
