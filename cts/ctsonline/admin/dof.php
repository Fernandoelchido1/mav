...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nombre_carpeta'])) {
    ...
    $fileMetadata = new Google_Service_Drive_DriveFile(array(
        ...
        'parents' => ["1y11bkO542mg0ud6mZvwV-kYVGzJZKwQX"] // ID de la carpeta principal
    ));
...
$optParams = array(
    'q' => "'1y11bkO542mg0ud6mZvwV-kYVGzJZKwQX' in parents", // Archivos y carpetas directamente en la carpeta principal
    'pageSize' => 100,
...
<body>
    ...
    <div class="container"><br>
            ...
            <article class="col-md-12">
                    <h1 class="align-content-center text-center" style="font-size: rem; letter-spacing: 3px;">DIARIO OFICIAL DE LA FEDERACIÓN</h1><br>
                    <p>
                    El Diario Oficial de la Federación (DOF) es el medio oficial de comunicación del gobierno mexicano, donde se publican leyes, reglamentos, decretos, acuerdos y otras disposiciones de interés nacional.</p><br>
                </article><br>
         </div><br>
        ...
        <div class="col-md-12 text-right">
            <div class="custom-file-container">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="file" class="custom-file-input" id="customFile" name="archivos" onchange="this.form.submit()" style="display: none;">
                </form>
            </div>
            <button type="button" class="btn btn-crear-carpeta" data-toggle="modal" data-target="#crearCarpetaModal">
                Crear Carpeta <i class="fas fa-folder"></i>
            </button>
        </div>
    </div>
</div>
                    ...
                    <div class="d-flex align-items-center justify-content-between border-bottom mb-2 pb-2"> <!-- Alineación horizontal y borde inferior -->
                        <div class="d-flex align-items-center"> <!-- Contenedor del icono y título -->
                            <?php if ($elemento->getMimeType() === 'application/vnd.google-apps.folder'): ?>
                                ...
                                <div>
                                <a href="carpeta6.php?carpeta_id=<?= $elemento->getId() ?>" style="text-decoration: none; color: inherit;">
                        ...
                        <div class="btn-group">
                            <form method="post" class="mr-2">
                                <button type="submit" class="btn btn-danger" name="eliminar" value="<?= $elemento->getId() ?>"> <!-- Margen derecho para separar los botones -->
