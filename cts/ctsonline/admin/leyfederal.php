...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nombre_carpeta'])) {
    ...
    $fileMetadata = new Google_Service_Drive_DriveFile(array(
        ...
        'parents' => ["1nO96OJeshy7gLwkkmOZZ3ffxTO7radYT"] // ID de la carpeta principal
    ));
...
$optParams = array(
    'q' => "'1nO96OJeshy7gLwkkmOZZ3ffxTO7radYT' in parents", // Archivos y carpetas directamente en la carpeta principal
    'pageSize' => 100,
...
<body>
    ...
    <div class="container"><br>
            ...
            <article class="col-md-12">
                    <h1 class="align-content-center text-center" style="font-size: rem; letter-spacing: 3px;">LEY FEDERAL</h1><br>
                    <p>
