...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nombre_carpeta'])) {
    ...
    $fileMetadata = new Google_Service_Drive_DriveFile(array(
        ...
        'parents' => ["1xbpCUL2Bt5XI4JV78EcllxlyXut1Fyy2"] // ID de la carpeta principal
    ));
...
$optParams = array(
    'q' => "'1xbpCUL2Bt5XI4JV78EcllxlyXut1Fyy2' in parents", // Archivos y carpetas directamente en la carpeta principal
    'pageSize' => 100,
...
<body>
    ...
    <div class="container"><br>
            ...
            <article class="col-md-12">
                    <h1 class="align-content-center text-center" style="font-size: rem; letter-spacing: 3px;">ENLACES</h1><br>
                    <p>
                    
Los enlaces fiscales son vínculos a recursos online que proveen información sobre regulaciones tributarias, leyes y jurisprudencia, facilitando el acceso rápido a datos relevantes para profesionales y académicos.</p><br>
                </article><br>
         </div><br>
                    ...
                    <div class="d-flex align-items-center justify-content-between border-bottom mb-2 pb-2"> <!-- Alineación horizontal y borde inferior -->
                        <div class="d-flex align-items-center"> <!-- Contenedor del icono y título -->
                            <?php if ($elemento->getMimeType() === 'application/vnd.google-apps.folder'): ?>
                                ...
                                <div>
                                <a href="carpeta5.php?carpeta_id=<?= $elemento->getId() ?>" style="text-decoration: none; color: inherit;">
...
<script>
    ...
    if (typeof folderCreatedMessage !== 'undefined') {
        Swal.fire({
            ...
            window.location.href = 'enlac.php';
        });
    }
</script>
