...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nombre_carpeta'])) {
    ...
    $fileMetadata = new Google_Service_Drive_DriveFile(array(
        ...
        'parents' => ["1GnZ9bcsWxPc7vVzaJpbymh5jlrjd7d6d"] // ID de la carpeta principal
    ));
...
$optParams = array(
    'q' => "'1GnZ9bcsWxPc7vVzaJpbymh5jlrjd7d6d' in parents", // Archivos y carpetas directamente en la carpeta principal
    'pageSize' => 100,
...
<script>
    ...
    if (typeof folderCreatedMessage !== 'undefined') {
        Swal.fire({
            ...
            window.location.href = 'leyfederal.php';
        });
    }
</script>
