...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nombre_carpeta'])) {
    ...
    $fileMetadata = new Google_Service_Drive_DriveFile(array(
        ...
        'parents' => ["1xjiBRDBjE3eqjeBizBYwJdxK6D3x9KG6"] // ID de la carpeta principal
    ));
...
$optParams = array(
    'q' => "'1xjiBRDBjE3eqjeBizBYwJdxK6D3x9KG6' in parents", // Archivos y carpetas directamente en la carpeta principal
    'pageSize' => 100,
...
<body>
    ...
    <div class="container"><br>
            ...
            <article class="col-md-12">
                    <h1 class="align-content-center text-center" style="font-size: rem; letter-spacing: 3px;">TABLAS E INDICADORES</h1><br>
                    <p>
                    Las tablas e indicadores fiscales son herramientas que resumen datos financieros y normativas tributarias, facilitando la toma de decisiones y el cumplimiento de obligaciones fiscales.</p><br>
                </article><br>
         </div><br>
                    ...
                    <div class="d-flex align-items-center justify-content-between border-bottom mb-2 pb-2"> <!-- Alineación horizontal y borde inferior -->
                        <div class="d-flex align-items-center"> <!-- Contenedor del icono y título -->
                            <?php if ($elemento->getMimeType() === 'application/vnd.google-apps.folder'): ?>
                                ...
                                <div>
                                    <a href="carpeta4.php?carpeta_id=<?= $elemento->getId() ?>" style="text-decoration: none; color: inherit;">
...
<script>
    ...
    if (typeof folderCreatedMessage !== 'undefined') {
        Swal.fire({
            ...
            window.location.href = 'teindicadores.php';
        });
    }
</script>
