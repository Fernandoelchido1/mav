...
<div class="menu">
    ...
    <div class="container"><br>
            ...
            <article class="col-md-12">
                    <h1 class="align-content-center text-center" style="font-size: rem; letter-spacing: 3px;">LEY HISTORICA</h1><br>
                    <p>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js"
    ...
    if (typeof folderCreatedMessage !== 'undefined') {
        Swal.fire({
            ...
            window.location.href = 'carpeta5.php?carpeta_id=".$_GET['carpeta_id']."';
        });
    }
</script>
