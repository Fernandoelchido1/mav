...
// Lógica para crear una nueva carpeta en la carpeta actual
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nombre_carpeta'])) {
    $nombre_carpeta = $_POST['nombre_carpeta'];
    $fileMetadata = new Google_Service_Drive_DriveFile(array(
        'name' => $nombre_carpeta,
        'mimeType' => 'application/vnd.google-apps.folder',
        'parents' => [$_GET['carpeta_id']] // ID de la carpeta actual
    ));
...
// Lógica para subir un archivo a la carpeta actual
...
$carpeta = $service->files->get($_GET['carpeta_id'], array('fields' => 'name'));
$nombre_carpeta_actual = $carpeta->getName();

// Obtener el contenido de la carpeta actual
$optParams = array(
    'q' => "'".$_GET['carpeta_id']."' in parents",
    'pageSize' => 100,
                    ...
                    <div class="d-flex align-items-center justify-content-between border-bottom mb-2 pb-2"> <!-- Alineación horizontal y borde inferior -->
                        <div class="d-flex align-items-center"> <!-- Contenedor del icono y título -->
                            <?php if ($elemento->getMimeType() === 'application/vnd.google-apps.folder'): ?>
                                ...
                                <div>
                                    <a href="carpeta2.php?carpeta_id=<?= $elemento->getId() ?>" style="text-decoration: none; color: inherit;">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js"
    ...
    if (typeof folderCreatedMessage !== 'undefined') {
        Swal.fire({
            ...
            window.location.href = 'carpeta2.php?carpeta_id=".$_GET['carpeta_id']."';
        });
    }
</script>
