...
if (isset($_POST['from'])) 
{
    ...
    if ($_POST['from']!="" AND $_POST['to']!="") 
    {
        ...
        $query="INSERT INTO agendas VALUES(null,'$titulo','$body','','$clase','$inicio','$final','$inicio_normal','$final_normal')";

        // Ejecutamos nuestra sentencia sql
        $conexion->query($query)or die('<script type="text/javascript">alert("Horario No Disponible ")</script>');

        // Obtenemos el ultimo id insetado
        $im=$conexion->query("SELECT MAX(id) AS id FROM agendas");
        $row = $im->fetch_row();  
        $id = trim($row[0]);
        ...
        $query="UPDATE agendas SET url = '$link' WHERE id = $id";
...
<div class="menu">
    ...
    <div class="barra-lateral">
        <div>
            ...
            <a class="text-decoration-none" href="../../premium/menul.php"><button  id="inicio" class="boton">
        ...
        <nav class="navegacion">
            <ul>
                <li>
                    <a href="../../premium/calculadora2.php">
                ...
                <li>
                    <a href="../../premium/teindicadores.php">
    ...
    <div class="container"><br>
            ...
            <article class="col-md-12">
                    <h1 class="align-content-center text-center" style="font-size: rem; letter-spacing: 3px;">CALENDARIO FISCAL</h1><br>
                    <p>
                    El calendario fiscal es el conjunto de fechas del año en las cuales vence el cumplimiento de las obligaciones tributarias del contribuyente, tanto periódicas como no periódicas.</p><br>
                </article>
         </div>
    ...
    <script type="text/javascript">
        (function($){
                ...
                var options = {
                    ...
                    // definimos que los agendas se mostraran en ventana modal
                    modal: '#events-modal', 

                        // dentro de un iframe
                        modal_type:'iframe',    

                        //obtenemos los agendas de la base de datos
